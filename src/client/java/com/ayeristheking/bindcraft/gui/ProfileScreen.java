...
public class ProfileScreen extends Screen {
    ...
    public ProfileScreen(Screen parent, Consumer<String> callback) {
        this(parent, Text.translatable("gui.BindCraft.prompt.enter_name").getString(), callback);
    }
    ...
    protected void init() {
        ...
        textField = new TextFieldWidget(textRenderer, cx + 8, cy + 34, BOX_W - 16, 20,
                Text.translatable("gui.BindCraft.name"));
        textField.setMaxLength(64);
        textField.setFocused(true);
        addDrawableChild(textField);

        addDrawableChild(ButtonWidget.builder(Text.translatable("gui.BindCraft.ok"), btn -> confirm())
