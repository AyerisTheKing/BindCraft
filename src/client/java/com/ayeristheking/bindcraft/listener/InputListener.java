package com.ayeristheking.bindcraft.listener;

import com.ayeristheking.bindcraft.binding.BindingManager;
...
public final class InputListener {
    ...
    /**
     * Bindings should only fire when no screen is open (or only the BindCraft screen is open
